...
let meta = 88.362 + (13.397 * weight) + (4.799 * length) - (5.677 * age);
let calorieRate = Math.round(meta * activityRate);
let proteins = Math.round(calorieRate * (40 / 100));
let fats = Math.round(calorieRate * (25 / 100));
let carbohydrates = Math.round(calorieRate * (35 / 100));
